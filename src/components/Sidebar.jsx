...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      >
        {showSidebar ? <RxCross2 className=" text-white text-3xl " /> :
      ...
      {path !== "/" && path !== "/employee-id" && path !== "/mail-code" && (
        ...
        className={`fixed top-0 z-10 left-0 bg-white sidebar min-h-[100vh] lg:w-[18%] w-[250px] lg:block
          ${showSidebar && !isAnimatingOut ? "animate__animated animate__slideInLeft animate__faster block" : ""}
          ${isAnimatingOut ? "animate__animated animate__slideOutLeft animate__faster" : ""}
        `}
        style={{ display: showSidebar || isAnimatingOut || screenWidth >= 1024 ? 'block' : 'none' }}
      >
