      ...
      <div className="sm:ms-[18%] sm:w-[82%] mt-14 w-full  p-10 bg-[#F4F6F8] ">
        <div className="w-full flex flex-row items-center p-3 rounded-xl  justify-end">
          <div className="  justify-center bg-gradient-to-r from-[#053BD3] to-[#03EAEA] p-[1px] rounded-lg">
            <button onClick={()=> navigate('/add-team')} className=" w-[150px] items-center justify-center p-2  px-5 h-[38px] flex  font-medium rounded-lg text-white  flex-row gap-1 ">
